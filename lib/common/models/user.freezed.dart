...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is User&&(identical(other.authId, authId) || other.authId == authId)&&(identical(other.email, email) || other.email == email)&&(identical(other.contactNo, contactNo) || other.contactNo == contactNo)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.name, name) || other.name == name)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.state, state) || other.state == state)&&(identical(other.city, city) || other.city == city)&&(identical(other.area, area) || other.area == area)&&const DeepCollectionEquality().equals(other.shortlistedSchools, shortlistedSchools)&&(identical(other.userType, userType) || other.userType == userType)&&(identical(other.sId, sId) || other.sId == sId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.iV, iV) || other.iV == iV));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,authId,email,contactNo,dateOfBirth,name,gender,state,city,area,const DeepCollectionEquality().hash(shortlistedSchools),userType,sId,createdAt,updatedAt,iV);

@override
String toString() {
  return 'User(authId: $authId, email: $email, contactNo: $contactNo, dateOfBirth: $dateOfBirth, name: $name, gender: $gender, state: $state, city: $city, area: $area, shortlistedSchools: $shortlistedSchools, userType: $userType, sId: $sId, createdAt: $createdAt, updatedAt: $updatedAt, iV: $iV)';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _User&&(identical(other.authId, authId) || other.authId == authId)&&(identical(other.email, email) || other.email == email)&&(identical(other.contactNo, contactNo) || other.contactNo == contactNo)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.name, name) || other.name == name)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.state, state) || other.state == state)&&(identical(other.city, city) || other.city == city)&&(identical(other.area, area) || other.area == area)&&const DeepCollectionEquality().equals(other._shortlistedSchools, _shortlistedSchools)&&(identical(other.userType, userType) || other.userType == userType)&&(identical(other.sId, sId) || other.sId == sId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.iV, iV) || other.iV == iV));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,authId,email,contactNo,dateOfBirth,name,gender,state,city,area,const DeepCollectionEquality().hash(_shortlistedSchools),userType,sId,createdAt,updatedAt,iV);
